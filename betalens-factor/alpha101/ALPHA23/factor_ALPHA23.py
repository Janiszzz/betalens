"""ALPHA23 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA23.yaml"
...
def compute_alpha23(high_wide, **kwargs):
    return compute_alpha(23, high_wide=high_wide, **kwargs)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA23 from YAML.")
