"""ALPHA70 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA70.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA70 from YAML.")
