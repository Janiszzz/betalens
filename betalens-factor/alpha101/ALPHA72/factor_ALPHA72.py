"""ALPHA72 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA72.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA72 from YAML.")
