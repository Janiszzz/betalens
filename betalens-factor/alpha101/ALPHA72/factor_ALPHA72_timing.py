...
def compute_alpha72_timing(high_wide, low_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(72, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
