"""ALPHA20 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA20_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA20 timing from YAML.")
