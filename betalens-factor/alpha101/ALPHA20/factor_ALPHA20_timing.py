...
def compute_alpha20_timing(open_wide, close_wide, high_wide, low_wide, **kwargs):
    return compute_alpha(20, open_wide=open_wide, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, **kwargs)
