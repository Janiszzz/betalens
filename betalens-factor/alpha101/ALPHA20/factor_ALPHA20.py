"""ALPHA20 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA20.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA20 from YAML.")
