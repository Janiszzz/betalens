...
def compute_alpha89_timing(low_wide, vwap_wide, amount_wide, industry_wide, **kwargs):
    return compute_alpha(89, low_wide=low_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, industry_wide=industry_wide, **kwargs)
