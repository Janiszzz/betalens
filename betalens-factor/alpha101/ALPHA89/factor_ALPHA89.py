"""ALPHA89 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA89.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA89 from YAML.")
