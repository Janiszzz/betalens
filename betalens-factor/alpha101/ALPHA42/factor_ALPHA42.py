"""ALPHA42 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA42.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA42 from YAML.")
