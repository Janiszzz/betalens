...
def compute_alpha5_timing(open_wide, close_wide, vwap_wide, **kwargs):
    return compute_alpha(5, open_wide=open_wide, close_wide=close_wide, vwap_wide=vwap_wide, **kwargs)
