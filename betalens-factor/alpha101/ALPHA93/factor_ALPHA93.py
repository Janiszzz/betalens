"""ALPHA93 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA93.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA93 from YAML.")
