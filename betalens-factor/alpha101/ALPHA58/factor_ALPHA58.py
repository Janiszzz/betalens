"""ALPHA58 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA58.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA58 from YAML.")
