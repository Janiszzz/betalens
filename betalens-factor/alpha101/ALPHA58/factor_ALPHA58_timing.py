...
def compute_alpha58_timing(volume_wide, vwap_wide, sector_wide, **kwargs):
    return compute_alpha(58, volume_wide=volume_wide, vwap_wide=vwap_wide, sector_wide=sector_wide, **kwargs)
