"""ALPHA17 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA17_timing.yaml"
...
def compute_alpha17_timing(close_wide, volume_wide, amount_wide, **kwargs):
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha17_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA17 timing from YAML.")
