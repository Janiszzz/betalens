"""ALPHA46 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA46.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA46 from YAML.")
