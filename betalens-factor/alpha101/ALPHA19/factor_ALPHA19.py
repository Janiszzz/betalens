"""ALPHA19 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA19.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA19 from YAML.")
