"""ALPHA38 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA38.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA38 from YAML.")
