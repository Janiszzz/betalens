"""ALPHA13 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA13.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA13 from YAML.")
