"""ALPHA10 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA10.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA10 from YAML.")
