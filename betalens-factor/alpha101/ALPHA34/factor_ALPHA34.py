"""ALPHA34 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA34.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA34 from YAML.")
