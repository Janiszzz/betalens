"""ALPHA101 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA101_timing.yaml"
...
def compute_alpha101_timing(
    open_wide,
    close_wide,
    high_wide,
    low_wide,
    *,
    high_low_epsilon=0.001,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA101 timing from YAML.")
