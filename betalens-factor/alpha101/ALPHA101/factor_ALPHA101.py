"""ALPHA101 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA101.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA101 from YAML.")
