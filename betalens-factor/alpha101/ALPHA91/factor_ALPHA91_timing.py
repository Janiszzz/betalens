"""ALPHA91 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA91_timing.yaml"
...
def compute_alpha91_timing(close_wide, volume_wide, vwap_wide, amount_wide, industry_wide, **kwargs):
    return compute_alpha(91, close_wide=close_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, industry_wide=industry_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha91_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA91 timing from YAML.")
