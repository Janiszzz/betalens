...
def compute_alpha7_timing(close_wide, volume_wide, amount_wide, **kwargs):
    return compute_alpha(7, close_wide=close_wide, volume_wide=volume_wide, amount_wide=amount_wide, **kwargs)
