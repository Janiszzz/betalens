"""ALPHA7 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA7_timing.yaml"
...
def compute_alpha7_timing(
    close_wide,
    volume_wide,
    amount_wide,
    *,
    close_delta_lag=7,
    change_rank_window=60,
    amount_average_window=20,
    volume_adv_false_value=-1.0,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA7 timing from YAML.")
