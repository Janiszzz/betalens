"""ALPHA39 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA39.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA39 from YAML.")
