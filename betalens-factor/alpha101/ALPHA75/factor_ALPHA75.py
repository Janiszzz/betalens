"""ALPHA75 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA75.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA75 from YAML.")
