...
def compute_alpha75_timing(low_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(75, low_wide=low_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
