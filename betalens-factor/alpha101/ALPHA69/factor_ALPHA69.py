"""ALPHA69 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA69.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA69 from YAML.")
