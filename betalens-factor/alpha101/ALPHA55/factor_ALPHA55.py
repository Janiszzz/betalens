"""ALPHA55 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA55.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA55 from YAML.")
