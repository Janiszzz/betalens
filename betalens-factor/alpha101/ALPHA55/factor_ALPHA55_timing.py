...
def compute_alpha55_timing(close_wide, high_wide, low_wide, volume_wide, **kwargs):
    return compute_alpha(55, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, **kwargs)
