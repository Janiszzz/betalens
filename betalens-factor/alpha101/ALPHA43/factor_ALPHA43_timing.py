"""ALPHA43 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA43_timing.yaml"
...
def compute_alpha43_timing(
    close_wide,
    volume_wide,
    amount_wide,
    *,
    amount_average_window=20,
    volume_adv_rank_window=20,
    close_delta_lag=7,
    delta_close_rank_window=8,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA43 timing from YAML.")
