"""ALPHA43 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA43.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA43 from YAML.")
