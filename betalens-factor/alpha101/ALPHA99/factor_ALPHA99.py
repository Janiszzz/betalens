"""ALPHA99 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA99.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA99 from YAML.")
