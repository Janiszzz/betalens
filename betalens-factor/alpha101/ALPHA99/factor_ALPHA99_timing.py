...
def compute_alpha99_timing(high_wide, low_wide, volume_wide, amount_wide, **kwargs):
    return compute_alpha(99, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, amount_wide=amount_wide, **kwargs)
