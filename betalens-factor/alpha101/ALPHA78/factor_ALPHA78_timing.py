"""ALPHA78 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA78_timing.yaml"
...
def compute_alpha78_timing(low_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha78_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA78 timing from YAML.")
