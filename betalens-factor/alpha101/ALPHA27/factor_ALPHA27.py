"""ALPHA27 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA27.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA27 from YAML.")
