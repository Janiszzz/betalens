"""ALPHA51 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA51.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA51 from YAML.")
