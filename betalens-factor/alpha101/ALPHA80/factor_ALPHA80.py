"""ALPHA80 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA80.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA80 from YAML.")
