...
def compute_alpha35_timing(close_wide, high_wide, low_wide, volume_wide, returns_wide, **kwargs):
    return compute_alpha(35, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, returns_wide=returns_wide, **kwargs)
