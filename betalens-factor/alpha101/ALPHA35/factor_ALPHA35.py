"""ALPHA35 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA35.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA35 from YAML.")
