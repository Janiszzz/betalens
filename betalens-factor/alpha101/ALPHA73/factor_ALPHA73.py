"""ALPHA73 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA73.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA73 from YAML.")
