...
def compute_alpha73_timing(open_wide, low_wide, vwap_wide, **kwargs):
    return compute_alpha(73, open_wide=open_wide, low_wide=low_wide, vwap_wide=vwap_wide, **kwargs)
