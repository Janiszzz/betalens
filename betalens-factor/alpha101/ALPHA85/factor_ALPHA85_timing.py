"""ALPHA85 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA85_timing.yaml"
...
def compute_alpha85_timing(close_wide, high_wide, low_wide, volume_wide, amount_wide, **kwargs):
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha85_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA85 timing from YAML.")
