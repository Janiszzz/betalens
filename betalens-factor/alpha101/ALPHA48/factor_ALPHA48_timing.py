"""ALPHA48 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA48_timing.yaml"
...
def compute_alpha48_timing(close_wide, subindustry_wide, **kwargs):
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha48_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA48 timing from YAML.")
