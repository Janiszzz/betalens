"""ALPHA44 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA44.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA44 from YAML.")
