"""ALPHA15 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA15.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA15 from YAML.")
