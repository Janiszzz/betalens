...
def compute_alpha2_timing(open_wide, close_wide, volume_wide, **kwargs):
    return compute_alpha(2, open_wide=open_wide, close_wide=close_wide, volume_wide=volume_wide, **kwargs)
