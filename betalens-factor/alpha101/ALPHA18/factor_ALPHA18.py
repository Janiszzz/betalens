"""ALPHA18 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA18.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA18 from YAML.")
