"""ALPHA79 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA79_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA79 timing from YAML.")
