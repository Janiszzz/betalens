"""ALPHA79 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA79.yaml"
...
def compute_alpha79(open_wide, close_wide, vwap_wide, amount_wide, sector_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA79 from YAML.")
