"""ALPHA25 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA25.yaml"
...
def compute_alpha25(close_wide, high_wide, vwap_wide, returns_wide, amount_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA25 from YAML.")
