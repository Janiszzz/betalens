"""ALPHA25 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA25_timing.yaml"
...
def compute_alpha25_timing(close_wide, high_wide, vwap_wide, returns_wide, amount_wide, **kwargs):
    return compute_alpha(25, close_wide=close_wide, high_wide=high_wide, vwap_wide=vwap_wide, returns_wide=returns_wide, amount_wide=amount_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha25_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA25 timing from YAML.")
