...
def compute_alpha52_timing(low_wide, volume_wide, returns_wide, **kwargs):
    return compute_alpha(52, low_wide=low_wide, volume_wide=volume_wide, returns_wide=returns_wide, **kwargs)
