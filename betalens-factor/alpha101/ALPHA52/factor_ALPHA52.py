"""ALPHA52 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA52.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA52 from YAML.")
