"""ALPHA47 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA47.yaml"
...
def compute_alpha47(close_wide, high_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA47 from YAML.")
