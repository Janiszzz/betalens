"""ALPHA47 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA47_timing.yaml"
...
def compute_alpha47_timing(close_wide, high_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(47, close_wide=close_wide, high_wide=high_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha47_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA47 timing from YAML.")
