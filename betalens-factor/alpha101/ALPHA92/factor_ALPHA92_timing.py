"""ALPHA92 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA92_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA92 timing from YAML.")
