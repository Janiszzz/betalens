...
def compute_alpha41_timing(high_wide, low_wide, vwap_wide, **kwargs):
    return compute_alpha(41, high_wide=high_wide, low_wide=low_wide, vwap_wide=vwap_wide, **kwargs)
