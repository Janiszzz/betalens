"""ALPHA41 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA41.yaml"
...
def compute_alpha41(high_wide, low_wide, vwap_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA41 from YAML.")
