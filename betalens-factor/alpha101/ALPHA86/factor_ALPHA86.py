"""ALPHA86 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA86.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA86 from YAML.")
