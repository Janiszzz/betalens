...
def compute_alpha86_timing(close_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(86, close_wide=close_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
