"""ALPHA36 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA36_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA36 timing from YAML.")
