"""ALPHA36 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA36.yaml"
...
def compute_alpha36(open_wide, close_wide, volume_wide, vwap_wide, returns_wide, amount_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA36 from YAML.")
