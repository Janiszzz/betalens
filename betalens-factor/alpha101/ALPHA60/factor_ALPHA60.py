"""ALPHA60 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA60.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA60 from YAML.")
