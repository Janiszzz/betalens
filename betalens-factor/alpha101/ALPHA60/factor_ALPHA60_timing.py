...
def compute_alpha60_timing(close_wide, high_wide, low_wide, volume_wide, **kwargs):
    return compute_alpha(60, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, **kwargs)
