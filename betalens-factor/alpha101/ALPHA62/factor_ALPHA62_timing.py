...
def compute_alpha62_timing(open_wide, high_wide, low_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(62, open_wide=open_wide, high_wide=high_wide, low_wide=low_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
