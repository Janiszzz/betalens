"""ALPHA62 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA62.yaml"
...
def compute_alpha62(open_wide, high_wide, low_wide, vwap_wide, amount_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA62 from YAML.")
