"""ALPHA49 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA49_timing.yaml"
...
def compute_alpha49_timing(close_wide, **kwargs):
    return compute_alpha(49, close_wide=close_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha49_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA49 timing from YAML.")
