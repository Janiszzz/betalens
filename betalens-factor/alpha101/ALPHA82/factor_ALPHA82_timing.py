...
def compute_alpha82_timing(open_wide, volume_wide, sector_wide, **kwargs):
    return compute_alpha(82, open_wide=open_wide, volume_wide=volume_wide, sector_wide=sector_wide, **kwargs)
