"""ALPHA82 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA82.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA82 from YAML.")
