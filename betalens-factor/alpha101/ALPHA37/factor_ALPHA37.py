"""ALPHA37 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA37.yaml"
...
def compute_alpha37(open_wide, close_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA37 from YAML.")
