"""ALPHA53 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA53.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA53 from YAML.")
