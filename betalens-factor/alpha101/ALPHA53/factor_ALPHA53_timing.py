...
def compute_alpha53_timing(close_wide, high_wide, low_wide, **kwargs):
    return compute_alpha(53, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, **kwargs)
