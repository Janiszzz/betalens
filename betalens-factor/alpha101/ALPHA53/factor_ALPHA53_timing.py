"""ALPHA53 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA53_timing.yaml"
...
def compute_alpha53_timing(
    close_wide,
    high_wide,
    low_wide,
    *,
    oscillator_delta_lag=9,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA53 timing from YAML.")
