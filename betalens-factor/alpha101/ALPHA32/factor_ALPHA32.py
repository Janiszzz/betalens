"""ALPHA32 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA32.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA32 from YAML.")
