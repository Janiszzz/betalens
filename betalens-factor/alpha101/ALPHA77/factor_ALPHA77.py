"""ALPHA77 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA77.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA77 from YAML.")
