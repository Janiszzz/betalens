"""ALPHA66 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA66_timing.yaml"
...
def compute_alpha66_timing(open_wide, high_wide, low_wide, vwap_wide, **kwargs):
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha66_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA66 timing from YAML.")
