...
def compute_alpha65_timing(open_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(65, open_wide=open_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
