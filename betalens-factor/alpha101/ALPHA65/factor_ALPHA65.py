"""ALPHA65 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA65.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA65 from YAML.")
