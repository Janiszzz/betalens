"""ALPHA40 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA40.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA40 from YAML.")
