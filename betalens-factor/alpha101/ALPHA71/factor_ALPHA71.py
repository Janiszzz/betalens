"""ALPHA71 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA71.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA71 from YAML.")
