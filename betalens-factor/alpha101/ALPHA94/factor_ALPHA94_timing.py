"""ALPHA94 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA94_timing.yaml"
...
def compute_alpha94_timing(vwap_wide, amount_wide, **kwargs):
    return compute_alpha(94, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha94_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA94 timing from YAML.")
