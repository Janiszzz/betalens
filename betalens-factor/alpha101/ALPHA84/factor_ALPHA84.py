"""ALPHA84 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA84.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA84 from YAML.")
