"""ALPHA16 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA16.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA16 from YAML.")
