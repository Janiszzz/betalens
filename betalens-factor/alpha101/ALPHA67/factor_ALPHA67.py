"""ALPHA67 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA67.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA67 from YAML.")
