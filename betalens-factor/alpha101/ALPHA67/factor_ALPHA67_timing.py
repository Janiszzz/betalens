...
def compute_alpha67_timing(high_wide, vwap_wide, amount_wide, sector_wide, subindustry_wide, **kwargs):
    return compute_alpha(67, high_wide=high_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, sector_wide=sector_wide, subindustry_wide=subindustry_wide, **kwargs)
