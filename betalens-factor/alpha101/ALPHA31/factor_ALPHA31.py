"""ALPHA31 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA31.yaml"
...
def compute_alpha31(close_wide, low_wide, amount_wide, **kwargs):
    return compute_alpha(31, close_wide=close_wide, low_wide=low_wide, amount_wide=amount_wide, **kwargs)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA31 from YAML.")
