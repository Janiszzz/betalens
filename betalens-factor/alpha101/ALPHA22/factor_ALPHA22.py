"""ALPHA22 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA22.yaml"
...
def compute_alpha22(close_wide, high_wide, volume_wide, **kwargs):
    return compute_alpha(22, close_wide=close_wide, high_wide=high_wide, volume_wide=volume_wide, **kwargs)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA22 from YAML.")
