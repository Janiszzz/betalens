"""ALPHA33 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA33.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA33 from YAML.")
