"""ALPHA100 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA100_timing.yaml"
...
def compute_alpha100_timing(close_wide, high_wide, low_wide, volume_wide, amount_wide, subindustry_wide, **kwargs):
    return compute_alpha(100, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, volume_wide=volume_wide, amount_wide=amount_wide, subindustry_wide=subindustry_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha100_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA100 timing from YAML.")
