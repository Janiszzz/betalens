"""ALPHA87 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA87.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA87 from YAML.")
