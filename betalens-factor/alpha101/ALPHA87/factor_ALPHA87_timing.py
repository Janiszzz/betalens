...
def compute_alpha87_timing(close_wide, vwap_wide, amount_wide, industry_wide, **kwargs):
    return compute_alpha(87, close_wide=close_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, industry_wide=industry_wide, **kwargs)
