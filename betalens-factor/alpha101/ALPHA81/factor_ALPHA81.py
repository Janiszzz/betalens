"""ALPHA81 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA81.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA81 from YAML.")
