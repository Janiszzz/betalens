...
def compute_alpha81_timing(volume_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(81, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
