"""ALPHA11 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA11.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA11 from YAML.")
