...
def compute_alpha11_timing(close_wide, volume_wide, vwap_wide, **kwargs):
    return compute_alpha(11, close_wide=close_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, **kwargs)
