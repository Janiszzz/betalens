"""ALPHA90 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA90.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA90 from YAML.")
