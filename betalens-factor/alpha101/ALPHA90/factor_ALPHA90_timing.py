...
def compute_alpha90_timing(close_wide, low_wide, amount_wide, subindustry_wide, **kwargs):
    return compute_alpha(90, close_wide=close_wide, low_wide=low_wide, amount_wide=amount_wide, subindustry_wide=subindustry_wide, **kwargs)
