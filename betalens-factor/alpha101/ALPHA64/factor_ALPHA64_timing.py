"""ALPHA64 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA64_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA64 timing from YAML.")
