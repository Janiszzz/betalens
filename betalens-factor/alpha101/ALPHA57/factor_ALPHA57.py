"""ALPHA57 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA57.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA57 from YAML.")
