"""ALPHA83 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA83_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA83 timing from YAML.")
