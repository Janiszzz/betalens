"""ALPHA54 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA54.yaml"
...
def compute_alpha54(open_wide, close_wide, high_wide, low_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA54 from YAML.")
