"""ALPHA54 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA54_timing.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA54 timing from YAML.")
