"""ALPHA21 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA21.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA21 from YAML.")
