...
def compute_alpha74_timing(close_wide, high_wide, volume_wide, vwap_wide, amount_wide, **kwargs):
    return compute_alpha(74, close_wide=close_wide, high_wide=high_wide, volume_wide=volume_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, **kwargs)
