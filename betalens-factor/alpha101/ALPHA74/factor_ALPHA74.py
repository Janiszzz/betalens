"""ALPHA74 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA74.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA74 from YAML.")
