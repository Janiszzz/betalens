...
def compute_alpha68_timing(close_wide, high_wide, low_wide, amount_wide, **kwargs):
    return compute_alpha(68, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, amount_wide=amount_wide, **kwargs)
