"""ALPHA68 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA68.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA68 from YAML.")
