"""ALPHA30 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA30.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA30 from YAML.")
