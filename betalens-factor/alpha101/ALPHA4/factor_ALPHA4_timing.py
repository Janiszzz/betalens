"""ALPHA4 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA4_timing.yaml"
...
def compute_alpha4_timing(
    low_wide,
    *,
    rank_low_rank_window=9,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA4 timing from YAML.")
