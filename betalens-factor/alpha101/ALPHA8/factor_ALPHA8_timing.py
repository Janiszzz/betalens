"""ALPHA8 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA8_timing.yaml"
...
def compute_alpha8_timing(
    open_wide,
    returns_wide,
    *,
    open_sum_window=5,
    returns_sum_window=5,
    base_delay_lag=10,
    stock_code=None,
    signal_weight=None,
):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA8 timing from YAML.")
