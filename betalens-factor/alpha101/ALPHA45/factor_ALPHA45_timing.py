"""ALPHA45 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA45_timing.yaml"
...
def compute_alpha45_timing(close_wide, volume_wide, **kwargs):
    return compute_alpha(45, close_wide=close_wide, volume_wide=volume_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha45_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA45 timing from YAML.")
