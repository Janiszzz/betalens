"""ALPHA95 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA95.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA95 from YAML.")
