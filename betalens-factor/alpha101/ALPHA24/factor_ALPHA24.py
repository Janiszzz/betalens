"""ALPHA24 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA24.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA24 from YAML.")
