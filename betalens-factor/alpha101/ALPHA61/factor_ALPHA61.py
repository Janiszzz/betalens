"""ALPHA61 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA61.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA61 from YAML.")
