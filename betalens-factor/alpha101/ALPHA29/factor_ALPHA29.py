"""ALPHA29 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA29.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA29 from YAML.")
