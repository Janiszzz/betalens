"""ALPHA14 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA14.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA14 from YAML.")
