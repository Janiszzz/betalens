...
def compute_alpha14_timing(open_wide, volume_wide, returns_wide, **kwargs):
    return compute_alpha(14, open_wide=open_wide, volume_wide=volume_wide, returns_wide=returns_wide, **kwargs)
