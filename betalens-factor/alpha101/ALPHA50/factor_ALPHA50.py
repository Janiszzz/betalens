"""ALPHA50 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA50.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA50 from YAML.")
