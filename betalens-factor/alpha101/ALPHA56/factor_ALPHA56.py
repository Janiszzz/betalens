"""ALPHA56 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA56.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA56 from YAML.")
