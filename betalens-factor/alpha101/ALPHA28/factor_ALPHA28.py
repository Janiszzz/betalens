"""ALPHA28 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA28.yaml"
...
def compute_alpha28(close_wide, high_wide, low_wide, amount_wide, **kwargs):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA28 from YAML.")
