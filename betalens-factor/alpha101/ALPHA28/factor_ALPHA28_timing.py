"""ALPHA28 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA28_timing.yaml"
...
def compute_alpha28_timing(close_wide, high_wide, low_wide, amount_wide, **kwargs):
    return compute_alpha(28, close_wide=close_wide, high_wide=high_wide, low_wide=low_wide, amount_wide=amount_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha28_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA28 timing from YAML.")
