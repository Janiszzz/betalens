"""ALPHA76 single-stock timing strategy."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA76_timing.yaml"
...
def compute_alpha76_timing(low_wide, vwap_wide, amount_wide, sector_wide, **kwargs):
    return compute_alpha(76, low_wide=low_wide, vwap_wide=vwap_wide, amount_wide=amount_wide, sector_wide=sector_wide, **kwargs)
...
def build_spec(config: dict, config_path: str | Path = _CONFIG_FILE) -> FactorSpec:
    ...
    return FactorSpec(
        ...
        compute=compute_alpha76_timing,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA76 timing from YAML.")
