"""ALPHA63 cross-sectional factor."""
...
_CONFIG_FILE = _FACTOR_DIR / "factor_ALPHA63.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ALPHA63 from YAML.")
